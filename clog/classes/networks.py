...
class EncoderDecoder(nn.Module):
    ...
    def __init__(self, encoder, decoder, src_embed, tgt_embed, generator, number_prototypes, d_model):
        ...
        self.prototypes = torch.tensor(np.random.rand(number_prototypes, d_model), requires_grad=False)
        self.c = 0
